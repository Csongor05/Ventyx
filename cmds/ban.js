...
let xdemb = new Discord.RichEmbed()
        ...
        .addField("Leírás:", `Kitiltja a felhasználot`, true)
        .addField("Használat:", `f.ban <említés> <indok>`, true)
        .addField("Példa:", `f.ban @Csongor Hirdetés`)
        ...
        if(member.user.id === "291221132256870400") return message.channel.send(":x: Nem tudtam kitiltani a **Készítőmet**!")
