...
if (member.user.bot === true) {
    ...
    bot = "Nem";
            ...
            let embed = new Discord.RichEmbed()
                ...
                .addField("Becenév", `${member.nickname !== null ? ` Nickname: ${member.nickname}` : "<:no:425632070036094986> Nincs"}`, true)
                .addField("Bot", `${bot}`,inline, true)
                .addField("Status", `${status[member.user.presence.status]}`, inline, true)
                .addField("Játékban", `${member.user.presence.game ? `🎮 ${member.user.presence.game.name}` : "Not playing"}`,inline, true)
